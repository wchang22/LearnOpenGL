...
void Texture::load_texture_from_image(const char* path) {
  ...
  switch (num_channels) {
    ...
    default:
      ...
      throw Exception::DisplayException((std::string("Invalid image type from ") +
                                         std::string(path)).c_str());
  }
...
void Texture::use_textures() const {
